...
//Change Mobile
if (isset($smt)) {
mysql_query("update admin set mobile='$cmobile' where user='$_SESSION[admin]'");
$cmobile="";
...
//Change Address
if(isset($smt1)){
mysql_query("update admin set address='$caddr' where user='$_SESSION[admin]'");
$caddr="";
//header("Location: profile.php");
}
...
//Change Email
if(isset($smt2)){
	mysql_query("update admin set email='$cemail' where user='$_SESSION[admin]'");
	$cemail="";
//header("Location: profile.php");
}
...
//Change Password
if(isset($smt3)){
	mysql_query("update admin set pass='$cpass' where user='$_SESSION[admin]'");
$cpass="";
//header("Location: profile.php");
}
?>
